...
(require "../miniKanren.rkt" "../absento.rkt" "../neq.rkt" "tester.rkt")
...
(define (test-mk)
  ...
  (test-check "lots of programs to make a 6"
              ...
              '((intexp (0 1 1))
                ...
                (sub1 (if #f _.0 (intexp (1 1 1))))
                (* (intexp (1)) (intexp (0 1 1)))
                (* (intexp (0 1 1)) (intexp (1)))
                (sub1 (sub1 (sub1 (sub1 (intexp (0 1 0 1))))))
                (if #t (sub1 (intexp (1 1 1))) _.0))
              #;
